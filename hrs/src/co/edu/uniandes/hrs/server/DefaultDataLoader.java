...
public class DefaultDataLoader  {
	...
	protected Hashtable<String, Integer> userId = new Hashtable<String, Integer>();
	protected Hashtable<String, Integer> businessId = new Hashtable<String, Integer>();
...
//			// debugging here..
	 ...
	 * The method can be overwritten in a subclass
	 */
	public void loadVerifyData(DataModel dm, String theUser) throws Exception {
		int counter = 0;
		// Read the file line by line and add the ratings to the data model.
		BufferedReader reader = new BufferedReader(new FileReader(filename));
		String line;
...
//		System.out.println("Binarization done (" + dm.getRatings().size() + " ratings)");
	 ...
	 * @return the user
	 */
	public Hashtable<Integer, String> getUser() {
		return user;
	}
	 ...
	 */
	public void setUser(Hashtable<Integer, String> user) {
		this.user = user;
	}
	 ...
	 * @return the business
	 */
	public Hashtable<Integer, String> getBusiness() {
		return business;
	}
	 ...
	 */
	public void setBusiness(Hashtable<Integer, String> business) {
	 ...
	 * @return the userId
	 */
	public Hashtable<String, Integer> getUserId() {
		return userId;
	}
	 ...
	 */
	public void setUserId(Hashtable<String, Integer> userId) {
		this.userId = userId;
	}
	 ...
	 */
	public Hashtable<String, Integer> getBusinessId() {
		return businessId;
	}
	 ...
	 */
	public void setBusinessId(Hashtable<String, Integer> businessId) {
